...
for i in range(len(students)):
    if students[i]['course'] == 'python':
        python.append(students[i]['name'])
    if students[i]['course'] == 'javascript':
        javascript.append(students[i]['name'])
    if students[i]['course'] == 'java':
        java.append(students[i]['name'])
    names_ages[students[i]['name']] = students[i]['age']
